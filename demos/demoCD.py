...
model = LinearRegression(learning_rate=0.000001 , iterations=2000 , tolerance=0.0000001 , optimizer_type="sgd")
...
plt.plot(list(range(1,2001)) , loss_history , label = 'Loss' , color = 'blue')
